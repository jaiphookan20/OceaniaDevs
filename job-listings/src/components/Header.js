...
const Header = () => {
  return (
    <header
      ...
      // }}
    >
      <div className="flex justify-center items-center bg-[#c3f53c]">
...
//   return (
//     <header
//       className="text-center py-12 mb-8 opacity-75 rounded-lg shadow-lg max-w-8xl mx-auto"
...
//           <img src={hero1} className="w-36 h-36 mb-2" />
//           <img src={hero2} alt="Header Image 1" className="w-36 h-36 mb-2" />
//         </div>
//         <div className="text-center p-3 rounded-md">
//           <div className="flex">
//             <h1 className="text-6xl font-bold text-black">Find what's next</h1>
//             <h1 className="text-6xl font-bold text-lime-500	">:</h1>
//           </div>
//           <p className="text-black mt-5 text-1xl">
//             THE BEST TECHNOLOGY JOBS, DOWN UNDER
//           </p>
//         </div>
//         <div className="flex flex-col items-center">
//           <img src={hero5} alt="Header Image 1" className="w-36 h-36 mb-2" />
//           <img src={hero3} className="w-36 h-36 mb-2" />
//         </div>
//       </div>
//     </header>
//   );
