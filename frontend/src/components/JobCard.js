...
//               <span className="bg-fuchsia-50 text-fuchsia-700 px-2 py-1 rounded-lg hover:underline cursor-pointer" onClick={()=> navigate(`company/${job.company_id}`)}>
//                 {job.company}
//               </span>
            ...
            <div className="flex items-center justify-between h-full">
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    <span className="bg-fuchsia-100 text-fuchsia-600 font-semibold px-2 py-1 rounded-lg hover:underline cursor-pointer" onClick={() => navigate(`/company/${job.company_id}`)}>
                      {job.company}
                    </span>
